...
|:----------------|:------------------------------------------------------------------------|
|**Actividad 331**|**Poster/Video** : Construir un poster/video  para cada uno de los modelos asignados que contenga sus principales características ([**Actividad331**](https://dgonxalex80.github.io/probabilidad20212.io/Actividad331.html))  |
...
|                |                                                                         | 
|:---------------|:------------------------------------------------------------------------|
|**Activiad 332**| De manera individual deberá seleccionar uno de los siguientes problemas ([**Actividad simulación**](https://dgonxalex80.github.io/probabilidad20212.io/Actividad332.html))  para ser resuelto con ayuda computacional. En un archivo pdf se deberán responder los interrogantes solicitados, adjuntado el código empleado |
|               | Trabajo individual                                                      |
|Fecha          | 3 de abril                                                              |
|Hora           | 23:59                                                                   |
